    ...
    return (
        <div id="home" className="home-section">
            <div className="left-side">
                ...
                <a target="_blank" href="https://drive.google.com/file/d/1belp8U8dU3kN7vjsUMWJNCCbrlo5i0I-/view?usp=sharing"><button className="resume-button">CHECK MY RESUME</button></a>
            </div>
